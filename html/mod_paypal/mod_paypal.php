...
function generateLink() {
	$links = array(
			'dart-creations.com',
			'DART Creations',
			'<a href="https://www.dart-creations.com">DART Creations</a>',
			'Powered by <a href="https://www.dart-creations.com">DART Creations</a>',
			'Powered by dart-creations.com',
			'Created by DART Creations',
			'For details refer to <a href="https://www.dart-creations.com">https://www.dart-creations.com</a>',
			'Developed by <a href="https://www.dart-creations.com">DART Creations</a>',
			'Powered by <a href="https://www.dart-creations.com">DART-Creations.com</a>',
			'Get this from <a href="https://www.dart-creations.com">DART-Creations.com</a>',
			'Joomla Paypal Module by <a href="https://www.dart-creations.com/">DART-Creations.com</a>'
	);

	$domain = $_SERVER['HTTP_HOST'];
	$domainHash = md5($domain);
	preg_match_all('!\d+!', $domainHash, $matches);
	if(isset($matches[0])) {
		$num = implode("", $matches[0]) + 101;
		$linkPick = abs($num % count($links));
		$link = $links[$linkPick];
	}
	else { // fallback
		$linkPick = 0;
	...
	if($_SERVER['REQUEST_URI'] != '/' || $linkPick == 0) {
